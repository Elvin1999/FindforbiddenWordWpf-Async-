...
namespace FindForbiddenWordWpf.Commands
{
    ...
    {
        public AddWordCommand(WordViewModel wordViewModel)
        {
        ...
        {
            var item=WordViewModel.CurrentWord;
            WordViewModel.AllWords.Add(item);
            WordViewModel.CurrentWord = new ForbiddenWord();
        }
    }
}
